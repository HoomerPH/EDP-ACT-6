...
Public Class Sex
    ...
    Public Property TextCatSex As Object
    ...
    Private Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        With Me
            ...
            Try
                strSQL = "Insert into sex values('" _
                & .TextCatID.Text & "', '" _
                & .TextCatSex.Text & "')"
    ...
    Private Sub btnDel_Click(sender As Object, e As EventArgs) Handles btnDel.Click
        ...
        Dim catSex As String = TextCatSex.Text
        ...
        If result = DialogResult.Yes Then
            Try
                Call Connect_to_DB()
                Dim query As String = "DELETE FROM sex WHERE sex_id = @sex_id AND cat_sex = @cat_sex"
                Dim cmd As New MySqlCommand(query, myconn)
                cmd.Parameters.AddWithValue("@sex_id", catID)
                cmd.Parameters.AddWithValue("@cat_sex", catSex)
    ...
    Private Sub DataGridView1_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellContentClick
        ...
        Dim id As Integer = Convert.ToInt32(selectedRow.Cells("sex_id").Value)
        Dim sex As String = selectedRow.Cells("cat_sex").Value.ToString()

        'Display the values in a message box
        MessageBox.Show("Selected row:" & vbCrLf & "CatID: " & id & vbCrLf & "CatSex: " & sex)
    End Sub
        ...
        If dlg.ShowDialog() = DialogResult.OK Then
            ...
            Using connection As New MySqlConnection(connectionString)
                ...
                For Each row As DataRow In dt.Rows
                    Dim insertSql As String = "INSERT INTO sex ("
    ...
    Private Sub btnRefresh_Click(sender As Object, e As EventArgs) Handles btnRefresh.Click
        ...
        Using connection As New MySqlConnection(connectionString)
            ...
            Dim selectSql As String = "SELECT * FROM sex"
    ...
    Private Sub PrintPageHandler(ByVal sender As Object, ByVal e As Printing.PrintPageEventArgs)
        ...
        Dim cmd As MySqlCommand = New MySqlCommand("SELECT sex_id, cat_sex
            FROM sex", conn)

...
Public Class Breed
    ...
    Public Property TextCatbreed As Object
    ...
    Private Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        With Me
            ...
            Try
                strSQL = "Insert into breed values('" _
                & .TextCatID.Text & "', '" _
                & .TextCatbreed.Text & "')"
    ...
    Private Sub btnDel_Click(sender As Object, e As EventArgs) Handles btnDel.Click
        ...
        Dim catBreed As String = TextCatbreed.Text
        ...
        If result = DialogResult.Yes Then
            Try
                Call Connect_to_DB()
                Dim query As String = "DELETE FROM breed WHERE breed_id = @breed_id AND cat_breed = @cat_breed"
                Dim cmd As New MySqlCommand(query, myconn)
                cmd.Parameters.AddWithValue("@breed_id", catID)
                cmd.Parameters.AddWithValue("@cat_breed", catBreed)
        ...
        If dlg.ShowDialog() = DialogResult.OK Then
            ...
            Using connection As New MySqlConnection(connectionString)
                ...
                For Each row As DataRow In dt.Rows
                    Dim insertSql As String = "INSERT INTO breed ("
    ...
    Private Sub btnRefresh_Click(sender As Object, e As EventArgs) Handles btnRefresh.Click
        ...
        Using connection As New MySqlConnection(connectionString)
            ...
            Dim selectSql As String = "SELECT * FROM breed"
    ...
    Private Sub DataGridView1_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellContentClick
        ...
        Dim id As Integer = Convert.ToInt32(selectedRow.Cells("breed_id").Value)
        Dim breed As String = selectedRow.Cells("cat_breed").Value.ToString()

        'Display the values in a message box
        MessageBox.Show("Selected row:" & vbCrLf & "CatID: " & id & vbCrLf & "CatBreed: " & breed)
    End Sub
    ...
    Private Sub PrintPageHandler(ByVal sender As Object, ByVal e As Printing.PrintPageEventArgs)
        ...
        Dim cmd As MySqlCommand = New MySqlCommand("SELECT breed_id, cat_breed
            FROM breed", conn)

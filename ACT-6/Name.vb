...
Public Class Name
    ...
    Public Property TextCatName As Object
    ...
    Private Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        With Me
            ...
            Try
                strSQL = "Insert into cat_name values('" _
                & .TextCatID.Text & "', '" _
                & .TextCatName.Text & "')"
    ...
    Private Sub btnDel_Click(sender As Object, e As EventArgs) Handles btnDel.Click
        ...
        Dim catName As String = TextCatName.Text
        ...
        If result = DialogResult.Yes Then
            Try
                Call Connect_to_DB()
                Dim query As String = "DELETE FROM cat_name WHERE catname_id = @catname_id AND nickname = @nickname"
                Dim cmd As New MySqlCommand(query, myconn)
                cmd.Parameters.AddWithValue("@catname_id", catID)
                cmd.Parameters.AddWithValue("@nickname", catName)
        ...
        If dlg.ShowDialog() = DialogResult.OK Then
            ...
            Using connection As New MySqlConnection(connectionString)
                ...
                For Each row As DataRow In dt.Rows
                    Dim insertSql As String = "INSERT INTO cat_name ("
    ...
    Private Sub DataGridView1_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellContentClick
        ...
        Dim id As Integer = Convert.ToInt32(selectedRow.Cells("catname_id").Value)
        Dim name As String = selectedRow.Cells("nicknamename").Value.ToString()

        'Display the values in a message box
        MessageBox.Show("Selected row:" & vbCrLf & "CatID: " & id & vbCrLf & "CatName: " & name)
    End Sub
    ...
    Private Sub btnRefresh_Click(sender As Object, e As EventArgs) Handles btnRefresh.Click
        ...
        Using connection As New MySqlConnection(connectionString)
            ...
            Dim selectSql As String = "SELECT * FROM cat_name"
    ...
    Private Sub btnExport_Click(sender As Object, e As EventArgs) Handles btnExport.Click
        'Connect to the MySQL database
        Dim connectionString As String = "Server=127.0.0.1;Database=cat_database;Uid=root;Pwd=shemitsme123;"
        Using connection As New MySqlConnection(connectionString)
            connection.Open()
    ...
    Private Sub PrintPageHandler(ByVal sender As Object, ByVal e As Printing.PrintPageEventArgs)
        Dim connString As String = "Server=localhost;Database=cat_database;Uid=root;Pwd=shemitsme123;"
        Dim conn As MySqlConnection = New MySqlConnection(connString)
        Dim cmd As MySqlCommand = New MySqlCommand("SELECT catname_id, nickname
            FROM cat_name", conn)
